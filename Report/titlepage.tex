...
The modules shall be seen in a treatment setting for the patients as a way to help themselves.

Based upon research regarding sleep estimation algorithms, a proof of concept solution is presented.
The solution can be seen as an initial solution but should be developed further before being used by the patients.
