...
\begin{figure}[h]
	...
	\caption{Accelerationsplot, hvor der blev sovet fra 22:00 til 07:00 næste dag.}\label{fig:accplot}
\end{figure}
...
\begin{figure}[h]
	...
	\caption{Amplitudeplot, hvor der blev sovet fra 22:00 til 07:00 næste dag.}\label{fig:amplplot}
\end{figure}
