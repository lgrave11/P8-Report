...
Registrering af ændring i adfærd er blevet understreget som helt centralt hvad angår forebyggelse for patienter med affektive lidelser \citep[Kapitel 1, Sektion 4]{misc:faellesrapp} \lars{check om denne passer}.
...
Det er tiltænkt at visualiseringerne skal være nemme at forstå og give et overblik over situationen, som også er nævnt af Jørgen Aagaard \citep[Kapitel 1, Sektion 4]{misc:faellesrapp} \lars{check om denne passer}. 
...
Pladsforbrug er også set på som del af et eksperiment til PsyLog systemet, der skal undersøge hvor meget plads ikke komprimeret og ikke aggregeret data ville fylde, se \citet[Kapitel 4, Sektion 6]{misc:faellesrapp} \lars{check om denne passer} for flere detaljer vedrørende dette.
