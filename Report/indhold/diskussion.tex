...
Registrering af ændring i adfærd er blevet understreget som helt centralt hvad angår forebyggelse for patienter med affektive lidelser \citep[Sektion 1.4]{misc:faellesrapp}.
...
Det er tiltænkt at visualiseringerne skal være nemme at forstå og give et overblik over situationen, som også er nævnt af Jørgen Aagaard \citep[Sektion 1.4]{misc:faellesrapp}. 
...
Pladsforbrug er også set på som del af et eksperiment til PsyLog systemet, der skal undersøge hvor meget plads ikke-komprimeret og ikke-aggregeret data ville fylde, se \citet[Sektion 3.4]{misc:faellesrapp} for flere detaljer vedrørende dette.
