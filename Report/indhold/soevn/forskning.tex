...
Metoden fungerer så ved at foretage en række feature udtrækninger\ivan{hvad er det?}, og så bruge teknikker såsom exponential moving average, Naive Bayes classifier og decision trees til at opnå den nøjagtighed.
...
Disse koefficienter kan bruges af os til at springe en eventuel lærings periode over, dog kan dette gå ud over præcisionen. \ivan{Forklar og diskuter}
