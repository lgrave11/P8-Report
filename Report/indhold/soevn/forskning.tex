...
\winde{Til den todo nedenuden, her lyder fint at have en nøjagtighed på 92\%}
...
\winde{Denne sætning lyder som om det er negativt at have en nøjagtighed på 92\% pga. den første del af sætningen}
...
\winde{Hvis man kan måle på ens vejrtrækninger, og på den måde se ens søvnkvalitet, så er det ikke nødvndigt at involvere brugeren?}
...
Denne metode bygger på at telefonen ligger i patientens seng og er ud fra de bevægelser der sker, i stand til at bestemme om patienten sover eller ej. \winde{Skal man så først tænde appen når man går i seng? Eller skal telefonen ligge i ens seng hele tiden?}
