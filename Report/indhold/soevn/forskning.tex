\ivan{evt noget om $\Delta$søvn ved udvikling af sygdomme. $\rightarrow\Delta$søvn som indikator (y), $\rightarrow\Delta$søvn som kilde til udvikling af sygdom (?).}
...
Best Effort Sleep (BES) Model \citet{6563918} bruger en fremgangsmåde der udelukkende baseres på målbare data fra en smartphone til at estimere en brugers søvnlængde.
