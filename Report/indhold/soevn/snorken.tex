...
\end{subfigure}
\caption{Personer vi ved snorker og person vi ved ikke snorker}
\label{fig:snorke-vs-ikkesnorken}
\end{figure}

Hvis man ser på grafen med snorken, \cref{fig:person-snorker}, kan man klart se at amplituden er meget mere uregulær i søvn perioden i forhold til grafen \cref{fig:person-ikke-snorker}. 
...
Men dette skal være baseret på hvor højt personen snorker og skal derfor være dynamisk, hvilket kan gøre at denne løsning ikke er optimal, på grund af dette ses der på forskellige metoder fra akademiske kilder på at opdage søvn.

Ud fra følgende artikler dannes der et grundlag for hvordan snorken registreres \citet{Dafna2013} og \citet{Calabrese20111101}.

\citet{Dafna2013} gør brug af et system til at inddele snorken og andre akustiske hændelse gennem et søvnforløb ved brug af lyd data der blev optaget med en mikrofon ved en polysomnigrafisk undersøgelse. 
...
Denne metode igen vil kræve at man ser på om denne metode kan bruges bare til amplitude eller om det nuværende system skal ændres til også at optage lyd. \winde{Den her sætning er MEGET underlig, bør skrives om.}
