...
Ydermere, vil et helt færdigt system påkræve testning hos målgruppen, og dette er igen en besværlig proces, der ikke er tid nok til at udføre. 

Denne sektion om proof of concept beskriver valg af sensor data, som er nødvendigt, hvordan søvnestimering udføres på denne data, og hvordan søvnestimeringerne for de forskellige sensorer kombineres og hvordan denne estimeringen skal aggregeres til individuelle perioder af søvn.
...
Alligevel regner vi med at amplituden stadig kan bruges, da man så muligvis kan finde et mønster når man snorker til at styrke modellen, hvilket vil blive diskuteret i \cref{section:snorken}.
...
Hvordan dette gøres bør overvejes ved videreudvikling, men til dette proof of concept kan man som en start bruge fastsatte statiske vægte.\winde{måske en kilde på her?}
...
Med mere tid kunne Toss 'N' Turn tilgangen blive forsøgt implementeret.\winde{Denne diskussion omkring TNT og BES, er lidt gentagelse?}
