...
Disse er den røde lineære funktion, den blå konkave funktion og den grønne logistiske funktion (se \citep{wiki:LogisticFunction}).
...
Vi har dog også fundet tilfælde hvor en aggregering ikke er akkurat, eksempelvis ved snorken fejler denne aggregering.\als{ref til diskussion om snorken. Plus find kilder på aggregering og diskuter disse - ellers kommer denne sektion til at fremstå for naivt.}
