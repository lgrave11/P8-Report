...
Denne konfigurationstabel har mange ligheder med den der er beskrevet i \citet[2.1 Konfigurationstabel]{misc:faellesrapp}.
...
\begin{figure}[]
	...
	\caption{Konfigurationstabellen for systemet.}
...
Metaforen for systemet er en objektiv søvndagbog, dette er valgt fordi det er sensorer der samler data og ved hjælp af disse laves en historie omkring hvordan ens søvn har været.
